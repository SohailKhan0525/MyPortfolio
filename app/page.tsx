...
export default function Home() {
  ...
  return <div className="site-shell">
    ...
    <footer className="footer section-pad"><div><span className="brand-mark small">Q</span><span>Mohd Zaheer Uddin</span></div><div className="footer-links"><Link href="/resume">Resume</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div><span>Built with Next.js</span></footer>
  </div>;
}
